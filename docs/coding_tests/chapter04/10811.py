...
bucket_count = [0]
str_bucket_count, str_ball_cycle = input().split()
bucket_count = [i for i in range(1,int(str_bucket_count)+1)]
ball_cycle = int(str_ball_cycle)

for x in range(ball_cycle) :
    str_range_first,str_range_second =input().split()
    s1 = bucket_count[int(str_range_first)-1]
    s2 = bucket_count[int(str_range_second)-1]
    bucket_count[int(str_range_second)-1] = s1
    bucket_count[int(str_range_first)-1] = s2
